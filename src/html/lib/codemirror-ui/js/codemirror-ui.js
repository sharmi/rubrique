...
CodeMirrorUI.prototype = {
	...
	*/
	...
	initLineNumberControl : function(){
		var linenumDiv = document.createElement("div");
		linenumDiv.className = "codemirror-ui-linenum"
		
		var label = document.createElement("label");
		
		this.lineNum = document.createElement("input");
		this.lineNum.type = "checkbox"
		this.lineNum.checked = true;
		label.appendChild(this.lineNum);
		label.appendChild(document.createTextNode("Line Numbers"));
		this.lineNum.onchange = this.toggleLineNumbers.bind(this);
		linenumDiv.appendChild(label);
		this.buttonFrame.appendChild(linenumDiv);
		},
	toggleLineNumbers : function(){
		if(this.lineNum.checked){
			this.mirror.setLineNumbers(true);
		}else{
			this.mirror.setLineNumbers(false);
		}
	},
